...
export default function Restaurant() {
  ...
  function deleteRestPageClick(rid: string) {
    console.log("Selected restaurant ID for deletion:", rid)
    setSelectedRID(rid)
    model.setPath("Manager Delete Restaurant")
    andRefreshDisplay()
  }
    ...
    <body>
      ...
      {model.isPath("Manage Unactivated") ? (
        <div className="container">
          ...
          <button className="wide button" onClick={() => deleteRestManagerPageClickFromInactive(restaurant.rid)}>Delete Restaurant</button><br></br>
      ...
      {model.isPath("Manage Activated") ? (
        <div className="container">
          ...
          <button className="bold wide button" onClick={() => deleteRestManagerPageClickFromActive(restaurant.rid)}>Delete Restaurant</button>
        </div>
      ) : null}
